...
public class LifeandstyleFragment extends BaseFragment{

    String LOG_TAG = LifeandstyleFragment.class.getSimpleName();

    @NonNull
    @Override
    public Loader<ArrayList<News>> onCreateLoader(int id, @Nullable Bundle args) {

        String section = getString(R.string.LIFEANDSTYLE);
